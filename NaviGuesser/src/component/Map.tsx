...
export default function MapComp({ allStops,pointed,setPointed }: any) {
  const ShowAll = allStops.map((stop: any) => {
    ...
    const customMarkerIcon = divIcon({
      ...
      className:
        "leaflet-marker-icon !origin-center leaflet-zoom-animated leaflet-interactive",
    });
    return (
  ...
  return (
    ...
    >
      <div className="flex items-start justify-end lg:justify-center">
        <input className="w-64 px-4 py-2 text-sm text-center border rounded-full shadow-xl lg:w-80 border-slate-200 lg:text-base"
